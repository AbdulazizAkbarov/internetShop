...
function Fodalanuvchi() {
  ...
  return (
    ...
    <div className="border max-w-[700px] w-[600]  rounded-lg">
    ...
    <div className="border max-w-[700px] w-[600]  rounded-lg">
      ...
      {location ? (
        <p className="text-xl font-bold pl-5 pb-15">Manzil Kirgizilmagan</p>
      ) : (
        <div>
          <select
            name=""
          ...
          <input
            ...
            className="border-1 border-[lightgrey] mx-3 mt-3 max-w-[669] outline-none p-4  rounded-lg"
          />
          ...
          <div className="flex items-center ">
            <input
              ...
              className="border-1 border-[lightgrey] mx-3 mt-3 max-w-[334] outline-none p-4  rounded-lg"
            />
            <input
              type="text"
              placeholder="Xonadon"
