    ...
    <div className="flex gap-5 flex-wrap py-8 px-12">
      {likeItems.length > 0 ? (
        ...
        <div className="inline-block w-full">
          <div className=" ml-[40%] mt-5 text-4xl font-bold">Sevimlilar bo'sh !</div>
          <Link href={"/"}>
            <button className="border-1 border-[#2C698D] cursor-pointer px-20 py-3 text-2xl font-bold rounded-lg mx-[39%] mt-7">
              Asosiyga otish
            </button>
          </Link>
        </div>
